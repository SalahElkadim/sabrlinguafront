// src/pages/AddListeningQuestionsToSTEP.jsx
...
export default function AddListeningQuestionsToSTEP() {
  ...
  const handleSubmit = async (e) => {
    ...
    for (let i = 0; i < questions.length; i++) {
      try {
        await stepQuestionsAPI.createListeningQuestion(audioId, {
    ...
    if (count === questions.length) {
      setTimeout(() => navigate(`/dashboard/step/skills/${skillId}`), 1500);
    }
  };
          ...
          <div key={idx} className="card border border-cyan-100 space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className={`w-full px-4 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500 bg-white ${
            ...
            {/* Explanation + English Explanation + Points */}
            <div className="grid grid-cols-3 gap-4">
              <div className="col-span-2 space-y-3">
                {" "}
                {/* ✅ غيّر col-span-2 عشان يضم الاتنين */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                  ...
                  <input
                    ...
                    placeholder="Explain the answer in Arabic..."
