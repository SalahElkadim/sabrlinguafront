// src/pages/general/AddReadingQuestionsToGeneral.jsx
...
export default function AddReadingQuestionsToGeneral() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      setError("");
      await generalQuestionsAPI.createReadingQuestion(passageId, {
