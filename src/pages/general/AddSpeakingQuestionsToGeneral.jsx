// src/pages/general/AddSpeakingQuestionsToGeneral.jsx
...
export default function AddSpeakingQuestionsToGeneral() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      setError("");
      await generalQuestionsAPI.createSpeakingQuestion(videoId, {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-xl font-bold text-gray-900">إضافة سؤال Speaking</h1>
      </div>
      <form
            ...
            <div key={i} className="flex items-center gap-2">
              ...
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className={`w-full pr-8 pl-4 py-2.5 border rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 text-right ${
