// src/pages/general/AddListeningQuestionsToGeneral.jsx
...
export default function AddListeningQuestionsToGeneral() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      setError("");
      await generalQuestionsAPI.createListeningQuestion(audioId, {
