// src/pages/AddVocabularyToPracticeExam.jsx
...
export default function AddVocabularyToPracticeExam() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await api.post("/ielts/practice/vocabulary/create/", submitData);
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="مثال: Choose the correct synonym for 'amazing'..."
            />
