// src/pages/ielts/AddSpeakingVideoToIELTS.jsx
...
export default function AddSpeakingVideoToIELTS() {
  ...
  const handleVideoUpload = async (e) => {
    ...
    try {
      ...
      if (data.public_id) {
        setVideoUrl(data.public_id);
        setVideoPreview(data.public_id);
        setForm((prev) => ({
          ...prev,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await ieltsQuestionsAPI.createSpeakingVideo(payload);
      const videoId = res.video?.id;
      navigate(
        `/dashboard/ielts/skills/${skillId}/add/speaking/video/${videoId}/questions`
      );
    } catch (err) {
