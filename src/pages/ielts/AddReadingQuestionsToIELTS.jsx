// src/pages/AddReadingQuestionsToIELTS.jsx
...
function QuestionForm({ index, onSave, onCancel, passageId, saved }) {
  ...
  const handleSave = async () => {
    ...
    setErrors({});
    try {
      await ieltsQuestionsAPI.createReadingQuestion(passageId, {
        ...form,
        options,
...
export default function AddReadingQuestionsToIELTS() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex gap-3">
        ...
        <button
          onClick={() => navigate(`/dashboard/ielts/skills/${skillId}`)}
