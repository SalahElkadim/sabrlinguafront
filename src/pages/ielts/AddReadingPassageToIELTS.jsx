// src/pages/AddReadingPassageToIELTS.jsx
import { useState } from "react";
import { useNavigate, useParams, Link } from "react-router-dom";
import { ArrowRight, Save } from "lucide-react";
import { ieltsQuestionsAPI } from "../../services/ieltsService";

export default function AddReadingPassageToIELTS() {
  ...
  const handleSubmit = async (e) => {
    ...
    setErrors({});
    try {
      const res = await ieltsQuestionsAPI.createReadingPassage({
        ...form,
        ielts_skill: skillId,
      });
      navigate(
        `/dashboard/ielts/skills/${skillId}/add/reading/passage/${res.passage.id}/questions`
      );
    } catch (err) {
