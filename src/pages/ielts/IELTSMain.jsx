  ...
  const sections = [
    {
      ...
      name: "IELTS Skills",
      description:
        "إدارة مهارات IELTS (Vocabulary, Grammar, Reading, Listening, Speaking, Writing)",
      icon: BookOpen,
    ...
    },
    {
      ...
      description:
        "ارفع كتباً أو ملفات صوت/فيديو وولّد أسئلة IELTS تلقائياً بالـ AI",
      icon: Sparkles,
      ...
      <div className="card bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
        <div>
          ...
          <p className="text-blue-100">
            إدارة منظومة اختبار IELTS - المهارات والأسئلة
          </p>
        </div>
      </div>
