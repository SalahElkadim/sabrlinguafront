...
export default function EditLesson() {
  ...
  const { units, fetchUnits, updateLesson, loading, error, clearError } =
    useLevelsStore();
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">تحديث بيانات الدرس التعليمي</p>
        </div>
      </div>
