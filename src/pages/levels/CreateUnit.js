...
const createUnitSchema = z.object({
  level: z.number({ required_error: "يجب اختيار المستوى" }),
...
export default function CreateUnit() {
  ...
  const { levels, fetchLevels, createUnit, loading, error, clearError } =
    useLevelsStore();
  const [success, setSuccess] = useState(false);

  const preSelectedLevelId = searchParams.get("level_id");
  ...
  const {
    ...
    defaultValues: {
      level: preSelectedLevelId ? parseInt(preSelectedLevelId) : undefined,
      order: 1,
      is_active: true,
    },
  });
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      setSuccess(true);
      setTimeout(() => {
        navigate(`/dashboard/units/${result.unit.id}`);
      }, 1500);
    } catch (err) {
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">
            املأ البيانات التالية لإنشاء وحدة دراسية
          </p>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            {levels.length === 0 ? (
              <div className="text-center py-8 bg-gray-50 rounded-lg">
                ...
                <p className="text-sm text-gray-600">جاري تحميل المستويات...</p>
              </div>
            ) : (
              ...
              <div className="mt-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="flex gap-2">
                  ...
                  <div className="text-sm text-blue-800">
                    <p className="font-medium">المستوى المحدد:</p>
                    <p>
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="input"
              placeholder="وصف مختصر عن الوحدة وما تحتويه من دروس..."
            />
          </div>
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500">
              الترتيب يحدد موضع الوحدة داخل المستوى
            </p>
          </div>
            ...
            <div className="flex gap-3">
              ...
              <div className="text-sm text-blue-800">
                ...
                <ul className="space-y-1 mr-4">
                  <li>• إنشاء بنك أسئلة خاص بالوحدة</li>
                  <li>• إعداد الهيكل الأساسي لامتحان الوحدة</li>
                  <li>• تجهيز النظام لإضافة الدروس</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-3 pt-6 border-t border-gray-200">
            ...
            <Link to="/dashboard/units" className="btn btn-secondary px-8 py-3">
              إلغاء
            </Link>
          </div>
        </form>
