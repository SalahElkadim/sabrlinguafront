// src/pages/AddLevelGrammarQuestion.jsx
...
export default function AddLevelGrammarQuestion() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await levelQuestionBanksAPI.addGrammar(bankId, formData);
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">إضافة سؤال قواعد</h1>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="input"
                required
                placeholder="مثال: Grammar Set 1 - Present Tenses"
              />
            </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                استخدم _____ للإشارة للفراغ في السؤال
              </p>
            </div>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                شرح الإجابة <span className="text-red-500">*</span>
              </label>
              <textarea
                name="explanation"
                ...
                className="input"
                required
                placeholder="شرح القاعدة النحوية والإجابة الصحيحة..."
              />
            </div>
