...
export default function AddMCQToEsp({ questionType = "VOCABULARY" }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isVocabulary) {
        await espQuestionsAPI.createVocabulary(payload);
      } else {
        await espQuestionsAPI.createGrammar(payload);
      }
