// src/pages/esp/AddListeningToEsp.jsx
...
export default function AddListeningAudioToEsp() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await espQuestionsAPI.createListeningAudio(formData);
      navigate(
        `/dashboard/esp/skills/${skillId}/add/listening/audio/${res.audio.id}/questions`
      );
    } catch (err) {
