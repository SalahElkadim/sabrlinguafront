    ...
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
      ...
      <div className="p-4 bg-gray-50">
        <div className="flex items-center justify-between mb-3">
          <button
            onClick={() => navigate(`/dashboard/esp/skills/${skillId}/add/listening/audio/${audio.id}/questions`)}
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
      ...
      <div className="p-4 bg-gray-50">
        <div className="flex items-center justify-between mb-3">
          <button
            onClick={() => navigate(`/dashboard/esp/skills/${skillId}/add/speaking/video/${video.id}/questions`)}
            className="flex items-center gap-1.5 text-sm text-emerald-600 hover:text-emerald-700 font-semibold"
          >
            <Plus className="w-4 h-4" />
            إضافة سؤال
  ...
  const fetchData = async () => {
    try {
      ...
      const [skillData, qData] = await Promise.all([
        ...
        espQuestionsAPI.getSkillQuestions(skillId),
      ]);
      setSkill(skillData);
