// src/pages/esp/EspSkillsList.jsx
...
export default function EspSkillsList() {
  ...
  const handleDelete = async () => {
    ...
    try {
      setDeleting(true);
      await espSkillsAPI.delete(deleteModal.id);
  ...
  const getSkillDetailsPath = (skill) => {
    ...
    return `/dashboard/esp/skills/${skill.id}`;
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() =>
            navigate(
              `/dashboard/esp/categories/${categoryId}/skills/create`
            )
          }
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() =>
                        navigate(
                          `/dashboard/esp/categories/${categoryId}/skills/${skill.id}/edit`
                        )
                      }
                ...
                <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                  <button
                    onClick={() =>
                      navigate(`/dashboard/esp/skills/${skill.id}`)
                    }
