...
export default function AddVocabularyQuestion() {
  const { bankId } = useParams();
  const navigate = useNavigate();
  const { addVocabularyQuestion, loading, error, clearError } =
 ...
 const handleImageUpload = async (e) => {
  ...
  const onSubmit = async (data) => {
    clearError();
    try {
      await addVocabularyQuestion(bankId, {
        ...data,
        is_active: true,
      });
      setSuccess(true);
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-600">أضف سؤال جديد لبنك الأسئلة</p>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="مثال: مفردات الألوان"
              />
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="مثال: What is the meaning of 'beautiful'?"
              />
